...
const Tabs = ({Cerca,Carica,Chat,Profilo }) => {
	...
	return (
		<Container>
			...
			<Menu onPress={() => navigation.navigate('Chat')}>
				<Icon source={require('../assets/icons/message.png')} />
				<MenuText>Chat</MenuText>
			</Menu>

			<Menu onPress={() => navigation.navigate('Carica')}>
				<Border
					start={{ x: 1, y: 0 }}
			...
			<Menu onPress={() => navigation.navigate('Cerca')}>
				<Icon source={require('../assets/icons/discover.png')} />
				<MenuText>Scopri</MenuText>
			</Menu>

			<Menu onPress={() => navigation.navigate('Profilo')}>
